  ...
  render() {
    ...
    var myStyle4 = {
      ...
      <div id="home" class="container-fluid text-center" style={myStyle1}>
        ...
        for example, online platforms are being used to reach out to more people liberating both the tutor and student constraints of space and time.  Yet, owever, a number of tutors still cling to the traditional face-to-face approach and you may be wondering why...</h1>
